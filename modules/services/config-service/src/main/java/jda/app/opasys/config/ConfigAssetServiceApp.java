...
@RefreshScope
@EnableEurekaClient
public class ConfigAssetServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(ConfigAssetServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(ConfigAssetServiceApp.class, args);
