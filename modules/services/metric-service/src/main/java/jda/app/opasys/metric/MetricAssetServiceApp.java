...
@RefreshScope
@EnableEurekaClient
public class MetricAssetServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(MetricAssetServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(MetricAssetServiceApp.class, args);
