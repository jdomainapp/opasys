package jda.app.opasys.commonknowledgeasset;
...
@RefreshScope
@EnableEurekaClient
public class CommonKnowledgeAssetServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(CommonKnowledgeAssetServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(CommonKnowledgeAssetServiceApp.class, args);
