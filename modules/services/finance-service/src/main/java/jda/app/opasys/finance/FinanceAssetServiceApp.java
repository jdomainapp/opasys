package jda.app.opasys.finance;
...
@RefreshScope
@EnableEurekaClient
public class FinanceAssetServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(FinanceAssetServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(FinanceAssetServiceApp.class, args);
