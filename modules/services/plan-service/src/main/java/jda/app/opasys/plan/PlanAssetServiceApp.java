...
@RefreshScope
@EnableEurekaClient
public class PlanAssetServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(PlanAssetServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(PlanAssetServiceApp.class, args);
