...
public class IssueServiceApp {
	private static final Logger logger = LoggerFactory.getLogger(IssueServiceApp.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(IssueServiceApp.class, args);
